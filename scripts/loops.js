...
btn.addEventListener('click', function () {
    ...
    for (let i = 0; i < cities.length; i++) {
        ...
        if (searchName === cities[i]) {
            result.textContent = "Your city is present in the list of cities.";
            console.log("Your city is present in the list of cities.");
            break;
        } else {
            result.textContent = "Your city is not present in the list of cities.";
            console.log("Your city is not present in the list of cities.");
        }
    }
});
