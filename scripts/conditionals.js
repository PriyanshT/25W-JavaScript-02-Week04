...
if (homeWorkDone === true) {
    // this block will be executed if the condition is satisfied
    coffeeTime = 20;
} else {
    // this block will be executed if the condition is not satisfied
    coffeeTime = 5;
}
...
function setWeather() {
    console.log("I am inside the function - setWeather.");
    ...
    if (choice === "sunny") {
        ...
        if (temperature >= 15) {
            ...
            page.style.backgroundColor = "orange"; // "#3426ff"
        } else {
...
coffeeBreak ? breakMessage.textContent = "Oh Yes! It's coffee time." : breakMessage.textContent = "Oh No! I want coffee.";
